...
\begin{FlushLeft}
  ...
  \entry{Systems Researcher}{BU Red Hat Collaboratory}{09/2023 - Present}
  \begin{itemize}
  \item \textbf{Unikernel Linux}: Hacked linux to dynamically link applications to kernel for performance gains in industrial workloads (e.g. improve redis throughput by 22\%)
  ...
  \begin{itemize}{
    \item Taught CS 131 (Combinatorics) for two semesters and CS 330 (Algorithms) for 3 semesters
